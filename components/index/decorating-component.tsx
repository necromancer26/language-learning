...
export default function DecoratingComponent() {
  return (
    <div className="relative  h-full w-full">
      <div
        className="h-[600px] w-[600px] bg-cover bg-center absolute rounded-md bg-black top-10 left-10 z-10"
        style={{
          backgroundImage:
      ...
      <div
        ...
        // }}
        className="h-[200px] absolute w-[200px] bottom-[10%] right-[5%] rounded-md bg-gray-700 bg-center bg-cover z-0"
      />
    </div>
  );
}
