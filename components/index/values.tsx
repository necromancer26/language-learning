...
export default function Values() {
  return (
    <div className=" lg:h-[70vh] bg-slate-900 flex text-slate-100">
      ...
      <div className="lg:w-1/2 bg-slate-100 flex">
        ...
        <div className="lg:w-1/3 bg-slate-400 flex justify-center items-center flex-1 hover:flex-[2_2_0%]  transition-all">
          <h3 className="mb-5 text-5xl font-bold  font-[spectral]">
