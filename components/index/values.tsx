export default function Values() {
  return (
    <div className=" lg:h-[50vh] bg-slate-900 flex flex-col lg:flex-row text-slate-100 snap-center h-full">
      <div className="flex justify-center items-center lg:w-1/2 lg:h-full h-[30vh]">
        <h2 className="mb-5 text-5xl font-bold  font-[spectral]">Our Values</h2>
      </div>
      <div className="lg:w-1/2 bg-slate-100 flex flex-col lg:flex-row w-full h-[90vh] lg:h-full">
