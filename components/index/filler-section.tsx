    ...
    <div className="lg:h-[100vh] bg-slate-100 flex flex-col md:flex-col lg:flex-row sm:flex-col lg:py-0 ">
      ...
      <Waypoint onEnter={() => setTriggerPicture(true)}>
       ...
       <div className="w-full h-[500px] lg:w-1/2 lg:h-full flex justify-center items-center ">
          ...
          >
            <div
              className="bg-[#2a9d8f] row-span-2 bg-center bg-cover scale-90 hover:scale-100 ease-in-out transition-all"
              style={{
                backgroundImage:
            ...
            <div
              className="bg-[#e9c46a] bg-center bg-cover scale-75 hover:scale-100 transition-all"
              style={{
                backgroundImage:
            ...
            <div
              className="bg-[#f4a261]  row-span-2 bg-center bg-cover scale-90 hover:scale-100 transition-all"
              style={{
                backgroundImage:
            ...
            <div
              className="bg-[#ffc8dd] bg-cover bg-center scale-95 hover:scale-100 transition-all "
              style={{
                backgroundImage:
